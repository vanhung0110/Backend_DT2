...
public interface MessageRepository extends JpaRepository<MessageEntity, Long> {
    ...
    // Fetch messages for room, optionally before a timestamp, newest first limited by pageable
    ...
    // Fetch messages after a timestamp (ascending order) to efficiently get new messages
    ...
    List<MessageEntity> findMessagesAfter(@Param("roomId") Long roomId, @Param("after") Instant after, Pageable pageable);
